...
tommy.goto(-250, 0)
tommy.color("orange")
tommy.write(",,ԾㅂԾ,,请仙女插上耳机后食用哦 ", font=('微软雅黑', 25, 'normal'))
...
tommy.write(" ( ͡° ͜ʖ ͡°)✧ 嘿，没猜错的话你们就是计算机班的小仙女了。 ", font=('微软雅黑', 15, 'normal'))
time.sleep(4)
...
tommy.penup()
tommy.goto(-250, -250)
tommy.write("祝你们女生节快乐！ ο(=•ω＜=)p⌒☆!", font=('微软雅黑', 24, 'normal'))
...
tommy.clear()
tommy.write("特用此小程序祝各位计算机班的女生们节日快乐~ ", font=('微软雅黑', 24, 'normal'))
time.sleep(4)
...
tommy.clear()
tommy.write("希望你们都能够在热爱的世界中闪闪发光！", font=('微软雅黑', 24, 'normal'))
time.sleep(4)
